        ...
        <div className="grid grid-cols-[50%_50%] max-w-full">
          ...
          <div className="px-12 py-8 flex flex-col justify-center bg-white relative overflow-visible h-[360px]">
            ...
            <div className="flex gap-20 items-center ml-10 ">
              <Button 
                className="bg-yellow-400 hover:bg-yellow-500 text-blue-900 py-7 pl-6 pr-[100px] text-sm font-bold rounded-md border-0 transition-colors duration-200 ml-11"
                data-testid="insurance-cta-button"
              >
                SEGURO, TE<br />
                LLAMAMOS
              ...
              <Button 
                variant="ghost" 
                className="text-blue-800 hover:text-blue-900 p-0 h-auto text-sm font-bold flex items-center gap-2 transition-colors duration-200 ml-[72px]"
                data-testid="insurance-more-info-button"
              >
                MÁS INFO
