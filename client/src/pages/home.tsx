      ...
      <main style={{ display: 'block' }}>
        ...
        <section className="bg-white py-6 lg:py-0">
          <div className="max-w-md lg:max-w-none mx-auto lg:mx-0 px-6 lg:px-0 lg:grid lg:grid-cols-[60%_40%] lg:min-h-[600px]">
            ...
            <div className="lg:flex lg:flex-col lg:justify-start lg:gap-0 space-y-6 lg:space-y-0 lg:pl-8 lg:pr-12 lg:pt-20">
              <div className="hidden lg:block lg:border-t-[3px] lg:border-green-500"></div>
              <EligeCorreos />
