  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pb-20">
        ...
        <section className="bg-white -mt-6 pt-0 pb-4 px-4">
          <div className="max-w-3xl mx-auto">
        ...
        <section className="bg-yellow-400 pt-2 pb-2" data-testid="steps-carousel">
          <div className="max-w-3xl mx-auto grid grid-cols-[auto_1fr_auto] items-start gap-0 px-4 h-[390px] md:h-[410px] lg:h-[440px]">
            {/* Botón anterior */}
            <button
              onClick={prevStep}
            ...
            <div className="text-center">
              ...
              {/* Número del paso */}
              <div className="text-base font-bold text-black mb-0 mt-4" data-testid={`step-number-${steps[currentStep].number}`}>
              ...
              <AccordionItem value="descripcion" className="border border-blue-950">
                ...
                <AccordionContent className="px-4 pb-4 text-gray-700">
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-3 list-disc ml-0 marker:text-black marker:font-bold">
