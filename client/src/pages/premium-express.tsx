        ...
        <section className="bg-yellow-400 pt-1 pb-4 relative overflow-hidden" data-testid="steps-carousel">
          ...
          <div className="max-w-3xl mx-auto px-4">
            <div className="text-center mx-12">
              ...
              {/* Número del paso */}
              <div className="text-4xl font-bold text-black mb-6" data-testid={`step-number-${steps[currentStep].number}`}>
                {steps[currentStep].number}
              </div>

              {/* Título */}
              {steps[currentStep].title && (
                <h3 className="text-xl font-bold text-black mb-6 leading-tight" data-testid={`step-title-${steps[currentStep].number}`}>
                  {steps[currentStep].title}
                </h3>
              )}
